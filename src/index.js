...
class PlayGame extends Phaser.Scene {
  ...
  update() {
    ...
    if (this.pauseAction === true) {
      this.physics.pause();
      let text = "Game Over";
      let lvlText = this.add.text(
        game.config.width / 2 - 120 * 2.7,
        game.config.height / 2 - (1 / 2) * 50,
        text,
        {
          fontSize: "120px",
          fill: "#FF4633",
